class Celestial {
    ...
    updateEnt(inputPos, inputMass) {
        ...
        this.magnitude = (document.getElementById("bigG").value / 100 * inputMass) / Math.pow(dist(this.pos.x, this.pos.y, inputPos.x, inputPos.y) + 1, 2); // This calculation determines the magnitude of the acceleration experienced by the object imparted by gravity
